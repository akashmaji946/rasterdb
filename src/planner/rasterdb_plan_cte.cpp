...
rasterdb_physical_plan_generator::create_plan(duckdb::LogicalMaterializedCTE& op)
{
  ...
  duckdb::unique_ptr<rasterdb::op::rasterdb_physical_cte> cte;
  cte                = duckdb::make_uniq<rasterdb::op::rasterdb_physical_cte>(op.ctename,
                                                           op.table_index,
                                                           right->types,
                                                           std::move(left),
                                                           std::move(right),
