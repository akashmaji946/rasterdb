...
string 
GPUPhysicalPartition::GetName() const {
    return "PARTITION";
}

bool 
GPUPhysicalPartition::IsSource() const {
    return true;
}

bool 
GPUPhysicalPartition::IsSink() const {
    return true;
}

void 
GPUPhysicalPartition::GetPartitionKeys(GPUPhysicalOperator* op, bool is_build) {
