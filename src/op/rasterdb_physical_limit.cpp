...
#include "op/rasterdb_physical_limit.hpp"
...
rasterdb_physical_streaming_limit::rasterdb_physical_streaming_limit(
  ...
  : rasterdb_physical_operator(
      RasterDBPhysicalOperatorType::STREAMING_LIMIT, std::move(types), estimated_cardinality),
...
int64_t rasterdb_physical_streaming_limit::claim(std::atomic<int64_t>& counter, int64_t max_claim)
{
...
std::unique_ptr<operator_data> rasterdb_physical_streaming_limit::execute(
  const operator_data& input_data, rmm::cuda_stream_view stream)
{
  nvtx3::scoped_range nvtx_range{"rasterdb_physical_streaming_limit::execute"};
