...
rasterdb_physical_duckdb_scan::rasterdb_physical_duckdb_scan(rasterdb_physical_table_scan* table_scan)
  : rasterdb_physical_duckdb_scan(
      table_scan->types,
      table_scan->function,
...
rasterdb_physical_duckdb_scan::rasterdb_physical_duckdb_scan(
  ...
  : rasterdb_physical_operator(
      RasterDBPhysicalOperatorType::DUCKDB_SCAN, std::move(types), estimated_cardinality),
