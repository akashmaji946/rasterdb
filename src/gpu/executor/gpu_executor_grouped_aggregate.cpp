...
// Tuple-key aggregate routing:
//   1  = force tuple-key path for supported fixed-width grouped aggregates
//   0  = disable tuple-key path and use legacy composite/GFXM routing
