...
class rasterdb_physical_order : public rasterdb_physical_operator {
 public:
  static constexpr const RasterDBPhysicalOperatorType TYPE = RasterDBPhysicalOperatorType::ORDER_BY;

  rasterdb_physical_order(duckdb::vector<duckdb::LogicalType> types,
