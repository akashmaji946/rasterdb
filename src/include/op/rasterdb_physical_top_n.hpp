...
class rasterdb_physical_top_n : public rasterdb_physical_operator {
 public:
  static constexpr const RasterDBPhysicalOperatorType TYPE = RasterDBPhysicalOperatorType::TOP_N;

 public:
  rasterdb_physical_top_n(duckdb::vector<duckdb::LogicalType> types_p,
                        duckdb::vector<duckdb::BoundOrderByNode> orders,
                        duckdb::idx_t limit,
                        duckdb::idx_t offset,
                        duckdb::shared_ptr<duckdb::DynamicFilterData> dynamic_filter,
                        duckdb::idx_t estimated_cardinality);
  ~rasterdb_physical_top_n() override;
