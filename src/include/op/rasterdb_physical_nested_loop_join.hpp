...
//! rasterdb_physical_nested_loop_join represents a nested loop join between two tables
class rasterdb_physical_nested_loop_join : public rasterdb_physical_partition_consumer_operator {
 public:
  static constexpr const RasterDBPhysicalOperatorType TYPE =
    RasterDBPhysicalOperatorType::NESTED_LOOP_JOIN;

 public:
  rasterdb_physical_nested_loop_join(
  ...
  rasterdb_physical_nested_loop_join(duckdb::LogicalOperator& op,
                                   duckdb::unique_ptr<rasterdb_physical_operator> left,
                                   duckdb::unique_ptr<rasterdb_physical_operator> right,
                                   duckdb::vector<duckdb::JoinCondition> cond,
                                   duckdb::JoinType join_type,
