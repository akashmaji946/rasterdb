...
class rasterdb_physical_table_scan : public rasterdb_physical_operator {
 public:
  static constexpr const RasterDBPhysicalOperatorType TYPE = RasterDBPhysicalOperatorType::TABLE_SCAN;

 public:
  //! Table scan that immediately projects out filter columns that are unused in the remainder of
  //! the query plan
  rasterdb_physical_table_scan(duckdb::vector<duckdb::LogicalType> types,
