...
class rasterdb_physical_grouped_aggregate : public rasterdb_physical_operator {
 public:
  static constexpr const RasterDBPhysicalOperatorType TYPE =
    RasterDBPhysicalOperatorType::HASH_GROUP_BY;

 public:
  rasterdb_physical_grouped_aggregate(
