...
class rasterdb_physical_ungrouped_aggregate : public rasterdb_physical_operator {
 public:
  static constexpr const RasterDBPhysicalOperatorType TYPE =
    RasterDBPhysicalOperatorType::UNGROUPED_AGGREGATE;

 public:
  rasterdb_physical_ungrouped_aggregate(
