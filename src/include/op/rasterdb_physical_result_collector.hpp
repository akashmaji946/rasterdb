...
class rasterdb_physical_result_collector : public rasterdb_physical_operator {
 public:
  static constexpr const RasterDBPhysicalOperatorType TYPE =
    RasterDBPhysicalOperatorType::RESULT_COLLECTOR;

 public:
  explicit rasterdb_physical_result_collector(::rasterdb::sirius_prepared_statement_data& data);
  ...
  rasterdb_physical_operator& plan;
 ...
 public:
  duckdb::vector<duckdb::const_reference<rasterdb_physical_operator>> get_children() const override;
...
class rasterdb_physical_materialized_collector : public rasterdb_physical_result_collector {
 public:
  rasterdb_physical_materialized_collector(::rasterdb::sirius_prepared_statement_data& data,
