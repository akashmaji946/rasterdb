...
class rasterdb_physical_sort_sample : public rasterdb_physical_operator {
 public:
  static constexpr const RasterDBPhysicalOperatorType TYPE = RasterDBPhysicalOperatorType::SORT_SAMPLE;
  ...
  rasterdb_physical_sort_sample(rasterdb_physical_order* order_by);

  rasterdb_physical_sort_sample(duckdb::vector<duckdb::LogicalType> types,
