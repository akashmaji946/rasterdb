...
void q19FilterExpression(uint64_t *p_brand, uint64_t *l_quantity, uint64_t *p_size, uint64_t* p_container, uint64_t *p_brand_val, uint64_t *l_quantity_val, uint64_t *p_size_val, uint64_t* p_container_val, 
            uint64_t* &row_ids, uint64_t* &count, uint64_t N);
